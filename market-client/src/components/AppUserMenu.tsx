...
const styles = {
  ...
  avatarDiv: {
    padding: "15px 0 10px 10px" as any,
    backgroundImage: ("url(" + require("../assets/to-icomoon-from-lera/icoTEST/avatars/user.svg") +")") as any,
  ...
  avatarIcon: {
    ...
    marginRight: 15,
    boxShadow: "0px 0px 0px 8px rgba(0,0,0,0.2)" as any,
  },
  avatarSpan: {
    paddingTop: 0,
    display: "block",
...
export default function AppUserMenu<AppUserMenuProps>({
  ...
  return (
    <div style={styles.avatarDiv}>
      <Avatar
        src={require("../assets/to-icomoon-from-lera/icoTEST/avatars/user.svg")}
